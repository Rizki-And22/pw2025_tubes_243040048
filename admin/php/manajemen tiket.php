...
?>
<?php $data_pelanggan = select("SELECT * FROM manajemen_tiket"); ?>
<!DOCTYPE html>
<html lang="id">
        ...
        <div class="flex-grow-1 d-flex flex-column min-vh-100">
            ...
            <div class="container py-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="tambah tiket.php" class="btn btn-success btn-custom">
                                    ...
                                    <?php if (!empty($data_pelanggan)): ?>
                                        ...
                                        <?php foreach ($data_pelanggan as $pelanggan): ?>
                                            <tr>
                                                ...
                                                <td><?= htmlspecialchars($pelanggan['Tanggal_Berlaku']); ?></td>
                                                <td>
                                                    <?php if ($pelanggan['Status'] == 'Aktif'): ?>
                                                        <span class="badge bg-success">Aktif</span>
                                                    <?php else: ?>
                                                        <span class="badge bg-secondary"><?= htmlspecialchars($pelanggan['Status']); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <a href="../edit/ubah_data_tiket.php?id=<?= urlencode($pelanggan['ID_Tiket']); ?>"
                                                        class="btn btn-outline-success btn-sm me-1" title="Ubah Data">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                    <a href="../hapus/hapus_data_tiket.php?id=<?= urlencode($pelanggan['ID_Tiket']); ?>"
